...
export function App() {
  ...
  const progress =
    chunks.length > 0 ? (completedCount / chunks.length) * 100 : 0;
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600">
            Convert long texts to speech by processing 2000-character chunks
            sequentially
          </p>
        </div>
            ...
            <CloneVoicePanel
              onCreated={(createdVoice) => {
                const newVoice: Voice = {
                  ...
                  displayName: createdVoice.displayName,
                  description: createdVoice.description || "",
                  tags: createdVoice.tags || [],
                  languages: createdVoice.promptLanguages || [],
                };

                setVoices((currentVoices) => [
                  newVoice,
                  ...currentVoices.filter(
                    (voice) => voice.voiceId !== newVoice.voiceId,
                  ),
                ]);
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  {voices.length > 0 ? (
                    ...
                    <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 text-center text-sm text-slate-500">
                      {loadingVoices
                        ? "Loading voices..."
                        : "Click 'Load Cloned Voices' to fetch your voices"}
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  >
                    <option value="inworld-tts-1.5-max">
                      inworld-tts-1.5-max
                    </option>
                ...
                <ol className="list-inside list-decimal space-y-2 text-sm text-slate-600">
                  ...
                  <li>
                    ...
                    <ul className="ml-5 mt-1 list-inside list-disc text-slate-500">
                      <li>
                        Split text into ~2000 character chunks at sentence
                        boundaries
                      </li>
